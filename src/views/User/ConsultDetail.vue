...
<template>
  <div class="consult-detail-page">
    ...
    <div class="detail-head">
      <div class="text">
        <h3>图文问诊 39 元</h3>
        <span class="status green">待支付</span>
        <p class="tip">服务医生信息</p>
      </div>
      <div class="card">
        <img class="avatar" src="@/assets/icons/avatar-doctor.svg" alt="" />
        <p class="doc">
          <span>极速问诊</span>
          <span>自动分配医生</span>
        </p>
      ...
      <van-cell-group :border="false">
        <van-cell title="订单编号">
          <template #value>
            ...
            220241106115032026101
          </template>
        </van-cell>
        <van-cell title="创建时间" value="2024-11-06 11:50:32" />
        <van-cell title="应付款" value="￥39.00" />
        <van-cell title="优惠券" value="-￥0" />
        <van-cell title="积分抵扣" value="-￥0" />
        <van-cell title="实付款" value="￥39.00" class="price" />
      </van-cell-group>
    </div>
    <div class="detail-time">
      请在 <van-count-down :time="10000 * 1000" /> 内完成支付，超时订单将取消
    </div>
    <div class="detail-foot van-hairline--top">
      <div class="price">
        <span>需付款</span>
        <span>￥39.00</span>
      </div>
...
.detail-head {
  ...
  .card {
    ...
    align-items: center;
    padding: 0 15px;
    box-shadow: 0px 0px 22px 0px rgba(229, 229, 299, 0.5);
    .avatar {
      width: 38px;
      height: 38px;
    }
